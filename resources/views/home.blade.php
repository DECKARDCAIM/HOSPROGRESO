...
<div class="container-fluid py-2">
  <div class="row">
    <div class="col-lg-12 position-relative z-index-2">
      ...
      <!-- Filtros de fecha y navegación de dashboards -->
      <div class="row mb-4">
        <div class="col-12">
              ...
              <form id="dashboard-filters">
                <div class="row g-3 align-items-end">
                  ...
                  <div class="col-md-2 col-sm-6">
                    ...
                    <input type="date" id="date-from" class="form-control form-control-sm border-0 shadow-sm" placeholder="Fecha inicio">
                  </div>
                  ...
                  <div class="col-md-2 col-sm-6">
                    ...
                    <input type="date" id="date-to" class="form-control form-control-sm border-0 shadow-sm" placeholder="Fecha fin">
                  </div>
                  
                  <!-- Botones de acción -->
                  <div class="col-md-2 col-sm-6">
                    <button type="button" id="apply-filters" class="btn btn-primary btn-sm w-100 shadow-sm">
                      <i class="bi bi-funnel me-1"></i>Aplicar
                    </button>
                  </div>
                  
                  <div class="col-md-2 col-sm-6" id="clear-filters-container" style="display: none;">
                    <button type="button" id="clear-filters" class="btn btn-outline-secondary btn-sm w-100 shadow-sm">
                      <i class="bi bi-arrow-clockwise me-1"></i>Limpiar
                    </button>
                  </div>
                  
                  <!-- Selector de dashboard (solo para administradores) -->
                  ...
                  <div class="col-md-4 col-sm-12">
                    ...
                    <div class="input-group">
                      <select id="dashboard-selector" class="form-select form-select-sm border-0 shadow-sm">
      @if($role === 'Administrador')
                        <option value="admin" selected>
                          <i class="bi bi-speedometer2"></i> Métricas Administrador
                        </option>
                        <option value="consultation">
                          <i class="bi bi-clipboard-pulse"></i> Métricas Consulta Externa
                        </option>
      ...
      @else
                      ...
                      <button type="button" id="refresh-metrics" class="btn btn-outline-secondary btn-sm shadow-sm" title="Actualizar métricas">
