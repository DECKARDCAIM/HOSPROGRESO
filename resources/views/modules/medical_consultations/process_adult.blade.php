...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Función para determinar servicio de hospitalización
    function determineHospitalService() {
        ...
        const specialtyName = '{{ $medicalConsultation->specialty->name ?? '' }}';
        ...
        if (patientAge < 18) {
            service = 'Pediatría';
        } else if (specialtyName.toLowerCase().includes('ginecolog') || specialtyName.toLowerCase().includes('obstetric')) {
            service = 'Ginecología';
