                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="physical_exam" class="form-control-label">Examen Físico</label>
                                            <textarea class="form-control @error('physical_exam') is-invalid @enderror" 
                                                      id="physical_exam" name="physical_exam" rows="6" 
                                                      placeholder="Examen físico general, signos vitales, evaluación de trauma, etc.">{{ old('physical_exam', $medicalConsultation->physical_exam) }}</textarea>
                                            @error('physical_exam')
