                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-end">
                                <a href="{{ url('/especialidades/create') }}" class="btn btn-sm btn-white">
                                    <i class="bi bi-plus me-2"></i>Nuevo Especialidad
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                @if ($search)
                                    <div class="col-auto ms-2">
                                                                        <a href="{{ url('/especialidades?status=' . $status) }}"
                                    ...
                                    @forelse ($specialties as $especialidad)
                                        <tr>
                                                ...
                                                <p class="text-sm text-secondary mb-0 d-flex align-items-center"
                                                    ...
                                                    <span class="ms-2">
                                                        <i class="bi bi-info-circle text-info" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="{{ $especialidad->description }}"></i>
                                                    </span>
                                                </p>
                                            </td>
                                            <td class="align-middle text-center">
                                                ...
                                                @else
                                                    <form
                                                        action="{{ route('especialidades.reactivate', $especialidad->id) }}"
                                                        method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit"
