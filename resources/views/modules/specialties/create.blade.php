            ...
            <div class="card mb-4 border">
                <div class="card-header pb-0 bg-brand-header">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h6 class="text-white mb-0">Nueva Especialidad</h6>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/especialidades') }}" method="POST" class="form-horizontal">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    <label for="name" class="form-control-label mb-2">
                                        <i class="bi bi-tag text-info me-2"></i>Nombre de la especialidad
                                    </label>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn bg-brand-header btn-lg text-white">
                                <i class="bi bi-check-lg me-2"></i>Crear especialidad
                            </button>
                        </div>
                    </form>
                </div>
