...
@section('title', 'Crear Relación de Acompañante')
@section('breadcrumb', 'Relaciones de Acompañantes / Crear')
            ...
            <div class="card mb-4 border">
                <div class="card-header pb-0 bg-brand-header">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h6 class="text-white mb-0">Nueva Relación de Acompañante</h6>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('companion-relationships.store') }}" method="POST" class="form-horizontal">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    <label for="name" class="form-control-label mb-2">
                                        <i class="bi bi-tag text-info me-2"></i>Nombre de la relación
                                    </label>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn bg-brand-header btn-lg text-white">
                                <i class="bi bi-check-circle me-2"></i>Crear relación
                            </button>
                        </div>
                    </form>
                </div>
