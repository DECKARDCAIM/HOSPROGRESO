...
@section('breadcrumb', 'Alergias / Crear')
            ...
            <div class="card mb-4 border">
                <div class="card-header pb-0 bg-brand-header">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h6 class="text-white mb-0">Nueva Alergia</h6>
                        </div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('allergies.store') }}" method="POST" class="form-horizontal">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control form-control-lg border border-2 border-info shadow-sm" placeholder="Nombre de la alergia" value="{{ old('name')}}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn bg-brand-header btn-lg text-white">
                                <i class="bi bi-check-lg me-2"></i>Crear alergia
                            </button>
                        </div>
                    </form>
                </div>
