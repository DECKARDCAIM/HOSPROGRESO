        ...
        <div class="col-12">
            <div class="card mb-4">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="text-sm text-white opacity-8 mb-0">
                                Este módulo permite gestionar las alergias registradas en el sistema.
                            </p>
                        </div>
                ...
                <div class="card-body pt-3 pb-2">
                    <form action="{{ url('/allergies') }}" method="GET" class="mb-0">
                        <div class="row align-items-center">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex px-3 py-2">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">{{ $allergy->name }}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-3 py-2">
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-4">
                                        <span class="text-muted">No hay alergias registradas.</span>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
