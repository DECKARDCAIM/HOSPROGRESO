...
@section('breadcrumb', 'Roles / Crear')
            ...
            <div class="card mb-4 border">
                <div class="card-header pb-0 bg-gradient-info">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h6 class="text-white mb-0">Nuevo Rol</h6>
                        </div>
                        <div class="col-md-4 text-end">
                            <a href="{{ route('roles.index') }}" class="btn btn-sm btn-white">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    <label for="name" class="form-control-label mb-2">
                                        <i class="fas fa-tag text-info me-2"></i>Nombre del rol
                                    </label>
                                    <input type="text" name="name" id="name" 
                                        ...
                                        value="{{ old('name')}}" 
                                        required>
                                    <div class="form-text text-muted">Ingrese el nombre completo del rol de usuario</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-text text-muted">Describa brevemente las funciones de este rol</div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-secondary btn-lg me-2" onclick="window.location.href='{{ route('roles.index') }}'">
