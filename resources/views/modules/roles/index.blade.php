                ...
                <div class="card mb-4">
                    <div class="card-header pb-0 bg-brand-header">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                            <h6 class="text-white mb-0">Roles</h6>
                                <p class="text-sm text-white opacity-8 mb-0">
                                Este módulo permite gestionar los roles de usuario registrados en el sistema.
                                </p>
                            </div>
                            <div class="col-md-4 text-end">
                                <a href="{{ route('roles.create') }}" class="btn btn-sm btn-white">
                                <i class="bi bi-plus me-2"></i>Nuevo Rol
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{ url('/roles') }}" method="GET" class="mb-0">
                            <div class="row align-items-center">
                                ...
                                <a href="{{ url('/roles?status=' . $status) }}" class="btn btn-outline-secondary">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-3 py-2" style="width: 35%; min-width: 300px; max-width: 500px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                <p class="text-sm text-secondary mb-0 d-flex align-items-center" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;">
                                                    ...
                                                    <span class="ms-2">
                                                        <i class="bi bi-info-circle text-info" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $role->description }}"></i>
                                                    </span>
                                                </p>
                                            </td>
                                            ...
                                            <a href="{{ route('roles.edit', $role) }}" class="btn bg-brand-header rounded-pill px-3 py-2 me-2">
