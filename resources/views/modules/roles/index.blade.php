                ...
                <div class="card mb-4">
                    <div class="card-header pb-0 bg-info">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h6 class="text-white mb-0">Roles de Usuario</h6>
                                <p class="text-sm text-white opacity-8 mb-0">
                                    Este módulo permite gestionar los roles de acceso al sistema.
                                </p>
                            </div>
                    ...
                    <div class="card-body pt-3 pb-2">
                        <form action="{{ route('roles.index') }}" method="GET" class="mb-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto ms-2">
                                    <a href="{{ route('roles.index', ['status' => $status]) }}" class="btn btn-outline-secondary">
                            ...
                            <table class="table align-items-center mb-0" id="datatable-basic">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">Usuarios</th>
                                ...
                                <tbody>
                                    @forelse ($roles as $role)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-2">
                                                    <div class="avatar avatar-sm me-3 bg-info rounded-circle">
                                                        <span class="text-white font-weight-bold">{{ substr($role->name, 0, 1) }}</span>
                                                    </div>
                                            ...
                                            <td class="px-3 py-2">
                                                <span class="badge bg-primary">{{ $role->users_count }} usuario(s)</span>
                                            </td>
                                            <td class="px-3 py-2" style="width: 35%; min-width: 300px; max-width: 500px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                <p class="text-sm text-secondary mb-0 d-flex align-items-center" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;">
                                                    ...
                                                    <span class="ms-2">
                                                        <i class="fas fa-info-circle text-info" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $role->description }}"></i>
                                                    </span>
                                                </p>
                                            </td>
                                                ...
                                                @if ($status === 'active')
                                                    ...
                                                    <form action="{{ route('roles.destroy', $role->id) }}"
                                                        ...
                                                        <button type="submit" class="btn btn-danger rounded-pill px-3 py-2"
                                                            onclick="return confirm('¿Está seguro? Esto desactivará a todos los usuarios con este rol.')">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center py-4">
                                                <span class="text-muted">No hay roles registrados.</span>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
