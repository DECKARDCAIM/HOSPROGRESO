                        ...
                        <form action="{{ route('doctors.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="third_name" id="third_name" class="form-control" value="{{ old('third_name') }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="married_lastname" id="married_lastname" class="form-control" value="{{ old('married_lastname') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="cui" class="form-label">CUI <span class="text-danger">*</span></label>
                                    <input type="text" name="cui" id="cui" class="form-control" value="{{ old('cui') }}" required maxlength="13">
                                </div>
                                <div class="col-md-6 mb-3">
