...
<head>
    ...
    <title>Citas Médicas - Reporte Múltiple</title>
    <style>
        @page {
    ...
    <div class="page-container">
        <div class="content-wrapper">
            ...
            <div class="generated-info">
                ...
                <strong>Cita:</strong> {{ $loop->iteration }} de {{ $appointments->count() }}
            </div>
        </div>
    </div>
    @endforeach
    ...
    <div class="footer">
        <div class="footer-content">
            ...
            <div style="margin-top: 3px; font-size: 9px;">
                Este documento contiene {{ $appointments->count() }} cita(s) médica(s). Conserve este documento para sus registros.
            </div>
        </div>
