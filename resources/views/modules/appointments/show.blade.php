                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-header">
                                    <h6><i class="bi bi-gear me-2"></i>Acciones Disponibles</h6>
                                </div>
                                <div class="card-body">
