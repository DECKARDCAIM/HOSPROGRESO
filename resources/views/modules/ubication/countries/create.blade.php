                        ...
                        <form action="{{ url('/paises') }}" method="POST" class="form-horizontal">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="name" class="form-control-label mb-2">
                                            <i class="bi bi-tag text-info me-2"></i>Nombre del pais
                                        </label>
                                        <input type="text" name="name" id="name"
                                            class="form-control form-control-lg border border-2 border-info shadow-sm"
                                            placeholder="Nombre del pais" value="{{ old('name') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" id="description" class="form-control form-control-lg border border-2 border-info shadow-sm"
                                            placeholder="Descripción del pais" rows="3" required>{{ old('description') }}</textarea>
                                        <div class="form-text text-muted">Describa brevemente en qué consiste este pais
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end mt-4">
                                <button type="button" class="btn btn-secondary btn-lg me-2 text-white"
                                    onclick="window.location.href='{{ url('/paises') }}'">
                                    <i class="bi bi-x me-2"></i>Cancelar
                                </button>
                                <button type="submit" class="btn bg-brand-header btn-lg text-white">
                                    <i class="bi bi-check-circle me-2"></i>Crear pais
                                </button>
                            </div>
                        </form>
                    </div>
