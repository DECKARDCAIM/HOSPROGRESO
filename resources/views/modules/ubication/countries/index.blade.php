                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <p class="text-sm text-white opacity-8 mb-0">
                                    Este módulo permite gestionar los países registrados en el sistema.
                                </p>
                            </div>
                            <div class="col-md-4 text-end">
                                <a href="{{ url('/paises/create') }}" class="btn btn-sm btn-white">
                                    <i class="bi bi-plus me-2"></i>Nuevo País
                                </a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="d-flex px-3 py-2">
                                                    <div class="avatar avatar-sm me-3 bg-brand-header rounded-circle">
                                                        <span
                                                            class="text-white font-weight-bold">{{ substr($country->name, 0, 1) }}</span>
                                                    </div>
                                                ...
                                                <p class="text-sm text-secondary mb-0 d-flex align-items-center"
                                                    ...
                                                    <span class="ms-2">
                                                        <i class="bi bi-info-circle text-info" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="{{ $country->description }}"></i>
                                                    </span>
                                                </p>
                                            </td>
                                            <td class="align-middle text-center">
                                                @if ($status === 'active')
                                                    <a href="{{ url('/paises/' . $country->id . '/edit') }}"
                                                ...
                                                @else
                                                    <form action="{{ url('/paises/' . $country->id . '/reactivate') }}"
