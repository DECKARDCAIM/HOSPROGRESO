                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="country_id" class="form-control-label mb-2">
                                            <i class="bi bi-globe-americas text-info me-2"></i>Filtrar por país
                                        </label>
                                        ...
                                        <div class="form-text text-muted">Seleccione el país para cargar sus departamentos
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ url('/municipios') }}" method="POST" class="form-horizontal">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="name" id="name"
                                            ...
                                            placeholder="Nombre del municipio" value="{{ old('name') }}" required>
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                ...
                                <button type="submit" class="btn bg-brand-header btn-lg text-white"
                                    ...
                                    <i class="bi bi-check-circle me-2"></i>Crear municipio
                                </button>
                            </div>
                        </form>
