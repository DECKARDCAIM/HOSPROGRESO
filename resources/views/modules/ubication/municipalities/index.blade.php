                        ...
                        <table class="table align-items-center mb-0" id="datatable-basic">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3" style="width: 35%; min-width: 300px; max-width: 500px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Descripción</th>
                                ...
                                @forelse ($municipalities as $municipality)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            @else
                                                <form action="{{ route('municipios.reactivate', $municipality->id) }}" method="POST" class="d-inline">
                                                    @csrf
