                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-end">
                                <a href="{{ url('/departamentos/create') }}" class="btn btn-sm btn-white">
                                    <i class="bi bi-plus me-2"></i>Nuevo Departamento
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                @if ($search)
                                    <div class="col-auto ms-2">
                                        <a href="{{ url('/departamentos?status=' . $status . ($country_id ? '&country_id=' . $country_id : '')) }}"
                                ...
                                <tbody>
                                    @forelse($departments as $department)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-2">
                                                    <div class="avatar avatar-sm me-3 bg-brand-header rounded-circle">
                                                        <span
                                                            class="text-white font-weight-bold">{{ substr($department->name, 0, 1) }}</span>
                                                    </div>
                                            ...
                                            <td class="px-3 py-2">
                                                <span
                                                    class="text-sm text-secondary">{{ $department->country->name ?? 'Sin país' }}</span>
                                            </td>
                                            <td class="px-3 py-2">
                                            ...
                                            <td class="align-middle text-center">
                                                ...
                                                @else
                                                    <form
                                                        action="{{ url('/departamentos/' . $department->id . '/reactivate') }}"
                                                        method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit"
