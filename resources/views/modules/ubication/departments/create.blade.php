...
@section('breadcrumb', 'Departamentos / Crear')
                ...
                <div class="card mb-4 border">
                    <div class="card-header pb-0 bg-brand-header">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h6 class="text-white mb-0">Nuevo departamento</h6>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/departamentos') }}" method="POST" class="form-horizontal">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="name" class="form-control-label mb-2">
                                            <i class="fas fa-tag text-info me-2"></i>Nombre del departamento
                                        </label>
                                        <input type="text" name="name" id="name"
                                            class="form-control form-control-lg border border-2 border-info shadow-sm"
                                            placeholder="Nombre del departamento" value="{{ old('name') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="country_id" class="form-control-label mb-2">
                                            <i class="fas fa-globe-americas text-info me-2"></i>País
                                        </label>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" id="description" class="form-control form-control-lg border border-2 border-info shadow-sm"
                                            placeholder="Descripción del departamento" rows="3" required>{{ old('description') }}</textarea>
                                        <div class="form-text text-muted">Describa brevemente en qué consiste este
                                            departamento</div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end mt-4">
                                <button type="button" class="btn btn-secondary btn-lg me-2 text-white"
                                    onclick="window.location.href='{{ url('/departamentos') }}'">
                                    <i class="fas fa-times me-2"></i>Cancelar
                                </button>
                                <button type="submit" class="btn bg-brand-header btn-lg text-white">
                                    <i class="fas fa-save me-2"></i>Crear departamento
                                </button>
                            </div>
                        </form>
                    </div>
