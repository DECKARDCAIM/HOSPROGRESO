            ...
            <div class="col-12">
                <div class="card mb-4">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-end">
                                <a href="{{ route('sexes.create') }}" class="btn btn-sm btn-white">
                                    <i class="bi bi-plus me-2"></i>Nuevo Sexo
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-3 pb-2">
                        <form action="{{ url('/sexes') }}" method="GET" class="mb-0">
                            <div class="row align-items-center">
                                ...
                                @if ($search)
                                    <div class="col-auto ms-2">
                                        <a href="{{ url('/sexes?status=' . $status) }}" class="btn btn-outline-secondary">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-2">
                                                    <div class="avatar avatar-sm me-3 bg-brand-header rounded-circle">
                                                        <span
                                                            class="text-white font-weight-bold">{{ substr($sex->name, 0, 1) }}</span>
                                                    </div>
                                            ...
                                            <td class="px-3 py-2"
                                                ...
                                                <p class="text-sm text-secondary mb-0 d-flex align-items-center"
                                                    ...
                                                    {{ Str::limit($sex->description, 60) }}
                                                    <span class="ms-2">
                                                        <i class="bi bi-info-circle text-info" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="{{ $sex->description }}"></i>
                                                    </span>
                                                </p>
                                            </td>
                                            <td class="align-middle text-center">
                                                @if ($status === 'active')
                                                    ...
                                                    <form action="{{ route('sexes.destroy', $sex) }}" method="POST"
                                                        class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                ...
                                                @else
                                                    <form action="{{ route('sexes.reactivate', $sex->id) }}" method="POST"
                                                        class="d-inline">
                                                        @csrf
                                                        <button type="submit"
